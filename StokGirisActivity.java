...
public class StokGirisActivity extends Activity implements OnKeyListener {
	...
	SpecialAdapter specialAdapater;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_stok_giris);
		...
		final String StokAdi = recieveBundle.getString("stokAdi");
	...
	private ArrayList<String> createExampleDialog(String urun) {
		final Dialog dialog = new Dialog(StokGirisActivity.this);
	...
	public void StokAna(String stokid, String miktari, String kod) {
